...
public class CertificateGenerator {
	...
	public static final String SIGNATURE_ALGORITHM = DIGEST_ALGORITHM + "with" + KEY_ALGORITHM;

	public static final String KEYSTORE_TYPE = "PKCS12";

	public static final String USER_CERT_ALIAS = "issued-cert";
	public static final String USER_CERT_PASSWORD = "pass";

	public static final String CA_CERT_ALIAS = "root-cert";
	public static final String CA_CERT_PASSWORD = "pass";

	public static final int SERVICE_PORT = 8080;

	public static final String OCRP_URL = "http://127.0.0.1:" + SERVICE_PORT + "/ocsp";
	public static final String CRL_URL = "http://127.0.0.1:" + SERVICE_PORT + "/crl";
	public static final String SIGN_URL = "http://127.0.0.1:" + SERVICE_PORT + "/sign";

	public static final String ROOT_CN = "CN=alex-sc-root";
	public static final String CERT_CN = "CN=alex-sc-user";

	private static boolean includeRevocation = false;
	...
	public static void main(String[] args) throws Exception {
		...
		X500Name rootCertIssuer = new X500Name(ROOT_CN);
		...
		exportKeyPairToKeystoreFile(rootKeyPair, rootCert, CA_CERT_ALIAS, "root-cert.pfx", KEYSTORE_TYPE, CA_CERT_PASSWORD);

		// Generate a new KeyPair and sign it using the Root Cert Private Key
		// by generating a CSR (Certificate Signing Request)
		X500Name issuedCertSubject = new X500Name(CERT_CN);
		...
		if (includeRevocation) {
			GeneralName ocspName = new GeneralName(GeneralName.uniformResourceIdentifier, OCRP_URL);
			AccessDescription ocsp = new AccessDescription(AccessDescription.id_ad_ocsp, ocspName);
			AuthorityInformationAccess authorityInformationAccess = new AuthorityInformationAccess(new AccessDescription[] { ocsp });
			issuedCertBuilder.addExtension(Extension.authorityInfoAccess, false, authorityInformationAccess);
		}

		// Add CRL URL
		if (includeRevocation) {
			GeneralNames generalNames = new GeneralNames(new GeneralName(GeneralName.uniformResourceIdentifier, CRL_URL));
			DistributionPoint[] distPoints = new DistributionPoint[] {
					new DistributionPoint(new DistributionPointName(generalNames), null, null)
			};
			issuedCertBuilder.addExtension(Extension.cRLDistributionPoints, false, new CRLDistPoint(distPoints));
		}
		...
		exportKeyPairToKeystoreFile(issuedCertKeyPair, issuedCert, USER_CERT_ALIAS, "issued-cert.pfx", KEYSTORE_TYPE, USER_CERT_PASSWORD);
	}
